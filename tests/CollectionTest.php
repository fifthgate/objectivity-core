...
class CollectionTest extends ObjectivityCoreTestCase
{
    ...
    public function testRemove(): void
    {
        ...
        $this->assertTrue($collection->hasID(2));
        $this->assertTrue($collection->hasID(3));
        $this->assertTrue($collection->remove($entityThree));
        $this->assertEquals(2, $collection->count());
        $this->assertFalse($collection->hasID(3));

        $this->assertTrue($collection->removeByID(2));
        $this->assertEquals(1, $collection->count());
        $this->assertFalse($collection->hasID(2));

        $this->assertFalse($collection->removeByID(2));
    ...
    public function testReplaceByDelta(): void
    {
        ...
        $updatedEntityOne = clone $entityOne;
        $updatedEntityOne->setDummyStringValue("stringX");

        $collection->replaceByDelta(0, $updatedEntityOne);
    ...
    public function testConstruct(): void
    {
        ...
        $collection = new MockDomainEntityCollection([$entityOne, $entityTwo, $entityThree]);
